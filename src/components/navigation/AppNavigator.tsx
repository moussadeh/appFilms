...
const AppNavigator = () => {
    ...
    return (
        <NavigationContainer>
            <Tab.Navigator screenOptions={{ tabBarActiveTintColor: '#F2C94C', tabBarInactiveTintColor: isDark ? 'white' : '#333333', headerShown: false, tabBarStyle: {backgroundColor: isDark ? 'black' : 'white', borderColor: isDark ? 'black' : 'white'} }}>
